...
try{
    ...
    //$bdd=new PDO("mysql:host=uauben.ipowermysql.com;dbname=timetable","edt","Edt2016.");
    //$bdd=new PDO("mysql:dbname=u522444409_time;host=mysql.hostinger.fr","u522444409_uaben","uauben_timetable");
